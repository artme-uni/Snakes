...
public class GameCreationPanel extends StripLayoutPanel {
    ...
    public GameCreationPanel() {
        ...
        fieldsPanel.addField("Playground width", 40, 10, 100, 1);
        fieldsPanel.addField("Playground height", 30, 10, 100, 1);
        fieldsPanel.addField("Food static", 1, 0, 100, 1);
        fieldsPanel.addField("Food per player", 1, 0, 100, 0.5);
        fieldsPanel.addField("State delay (ms)", 1000, 1, 10000, 100);
        fieldsPanel.addField("Dead food prob", 0.1, 0, 1, 0.1);
